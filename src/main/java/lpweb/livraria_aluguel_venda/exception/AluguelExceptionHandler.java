package lpweb.livraria_aluguel_venda.exception;
...
import java.util.stream.Collectors;
    ...
    public class AluguelExceptionHandler extends ResponseEntityExceptionHandler {
        ...
        public Resposta<Erro> handleEmptyResultDataAccess(EmptyResultDataAccessException ex) {
            ...
            String mensagem = String.format("Livro nao encontrado, Livro nao disponivel para aluguel %d ",
